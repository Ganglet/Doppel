...
The page answers one question: which synthetic-data generator is realistic, useful and private? It has five sections: Overview, Compare, Trade-offs, Privacy and Project. Every chart has a "Show table" view, works with the keyboard, and follows the system light or dark theme (there is also a toggle).
